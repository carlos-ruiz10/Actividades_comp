...
?>
<?php
	$sql_trabajador = 'SELECT * FROM trabajador WHERE nombre_tra LIKE :search';
	$search_terms = isset($_GET['nombre_tra'])? $_GET["nombre_tra"]: '';
							...
							<div class="row">
								<div class="col s12">
									<label>Ingrese el nombre del trabajador
										<input type="text" name="nombre_tra" placeholder="ej. Jose">
